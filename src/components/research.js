...
const ActiveResearchLeftContainer = styled.div`
  flex-grow: 1;
  margin-right: 20px;
`

const ActiveResearchRightContainer = styled.div`
  flex-grow: 2;
`
...
const topics = [
  {
    ...
    description:
      'To better comprehend the role of individual functional networks within mitochondria and between mitochondria and the remainder of the cell, we decided to establish a mitochondrial interactome using a proximity biotinylation assay, BioID. BioID uses a promiscuous biotin ligase covalently fused to a protein of interest (bait), which subsequently biotinylates proteins in the vicinity of the bait. Using BioID we can identify novel mitochondrial proteins, determine the localization of an individual protein within the mitochondrion as well as within a functional network, and identify novel roles for proteins both within and outside the mitochondria. In addition, we are investigating how individual interactomes change when mutant protein variants are present, yielding insight into possible pathogenic mechanisms and potential treatment targets. If you got interested please contact Hana by email from our lab.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    description:
      'Mitochondria fusion and fission is a highly dynamic process and the former is regulated by the concerted action of mitofusion1/2 and OPA1 coordinated by Ugo1. Alex not so long ago identified a novel homozygous missense mutation (c.425C > T) in SLC25A46, the human orthologue of Ugo1 in a Leigh syndrome patient. SLC25A46 is known to be a mitochondria solute carrier protein and it promotes mitochondrial fission. SLC25A46 patient derived fibroblasts reveal altered mitochondrial and ER architecture associated with disrupted MICOS complex as well as altered lipid composition suggesting that SLC25A46 could be a putative lipid transfer protein at ER-Mito contact sites. To this end a sensitive proximity-based biotinylation assay for identifying the interactome of SLC25A46 was done in order to elucidate its function. BioID screen and Co-IP have revealed promising uncharacterized proteins which mostl likely have important roles at the ER-mito contact. We are using a broad range of biochemical methods and cell imaging techniques to uncover these exciting and novel mysteries. If you got interested please contact Alexandre, Archita or Mari by email from our lab.',
  },
  {
    id: 4,
